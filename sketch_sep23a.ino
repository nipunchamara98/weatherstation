...
// WiFi DETAILS
const char* ssid = "Nipun";         // wifi SSID
const char* password = "12345678";    // Wifi password

// Google script ID
String GOOGLE_SCRIPT_ID = "AKfycby87Naa55-8paHMnfRA_YWFyuLzbf4VDs8OP_9cso9bg-WaD07GC3nxFgDHu3xUkV2nw";    // Google shwwt id
unsigned long thingsPeakID = 1872622; // thingSpeak id

using namespace std; //"SPIFFS.h library

const char *writeAPIKey = "IGGS23FWHNNTU3"; // thingSpeak API
WiFiClient client;
